                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{__('custom.page_list')}}</li>
                        </ol>
                    </nav>
                </div>
                <div class="ms-auto">
                    <div class="btn-group">
                        <a href="{{ route('page.create') }}" class="btn btn-primary"> {{__('custom.add')}}</a>
                    </div>
                </div>
            </div>
            <!--end breadcrumb-->
                        ...
                        <table id="example2" class="table table-striped table-bordered">
                            ...
                            @foreach($pages as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('page.edit',[ $item->id ])}}" class="btn btn-info text-white">{{__('custom.edit')}}</a>
                                        @if($item->id !=  1)
