    ...
    <div class="page-wrapper">
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">{{__('custom.services')}}</div>
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">{{__('custom.service')}} {{__('custom.list')}}</li>
                        </ol>
                    </nav>
                </div>
                <div class="ms-auto">
                    <div class="btn-group">
                        <a href="{{route('service.create')}}" class="btn btn-primary"> {{__('custom.add')}}</a>
                    </div>
                </div>
            </div>
            <!--end breadcrumb-->
                        ...
                        <table id="example" class="table table-striped table-bordered">
                            ...
                            @foreach($services as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('service.edit',['service' => $item->id ])}}" class="btn btn-info text-white">{{__('custom.edit')}}</a>
