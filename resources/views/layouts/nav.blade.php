...
<div class="sidebar-wrapper" data-simplebar="true">
            ...
            <ul class="metismenu" id="menu">
                ...
                <li>
                    ...
                    <ul>
                        <li> <a href="{{ route('time.create') }}"><i class="bx bx-right-arrow-alt"></i>System</a></li>
                        ...
                        <li> <a href="{{ route('page.index') }}"><i class="bx bx-right-arrow-alt"></i>Pages</a></li>
                    </ul>
                </li>
                <li>
                    <a href="javascript:;" class="has-arrow">
                    ...
                    <ul>
                        <li> <a href="{{ route('user.index') }}"><i class="bx bx-right-arrow-alt"></i>User List</a></li>
                        <li> <a href="{{ route('user.create') }}"><i class="bx bx-right-arrow-alt"></i>Create User</a></li>
                    </ul>
                </li>
                <li>
                ...
                <li>
                    ...
                    <ul>
                        <li> <a href="{{ route('campaign.index') }}"><i class="bx bx-right-arrow-alt"></i>Campaign List</a></li>
                        <li> <a href="{{ route('campaign.create') }}"><i class="bx bx-right-arrow-alt"></i>Create Campaigns</a></li>
                    </ul>
                </li>
                <li>
                    <a href="javascript:;" class="has-arrow">
